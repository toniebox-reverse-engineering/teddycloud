...
#define CONTENT_LENGTH_MAX (1024 * 1024 * 50)
...
#define MQTT_CLIENT_DEFAULT_TIMEOUT 500
...
#define MQTT_CLIENT_MAX_WILL_TOPIC_LEN 64
...
#define HTTP_TRACE_LEVEL TRACE_LEVEL_WARNING
