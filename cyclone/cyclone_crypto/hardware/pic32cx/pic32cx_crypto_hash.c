...
//ICM region descriptor
static Pic32cxIcmDesc icmDesc __attribute__((aligned(64)));
//ICM hash area
   ...
   uint32_t *h)
{
   ...
   osAcquireMutex(&pic32cxCryptoMutex);
   ...
   osReleaseMutex(&pic32cxCryptoMutex);
}
