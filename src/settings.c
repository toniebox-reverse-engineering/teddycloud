...
static void option_map_init(uint8_t settingsId)
{
    ...
    OPTION_INTERNAL_STRING("internal.toniebox_firmware.uaVersionFirmware", &settings->internal.toniebox_firmware.uaVersionFirmware, "", "Firmware version from User Agent")
    OPTION_INTERNAL_STRING("internal.toniebox_firmware.uaVersionServicePack", &settings->internal.toniebox_firmware.uaVersionServicePack, "", "Service Pack version from User Agent")
    OPTION_INTERNAL_STRING("internal.toniebox_firmware.uaVersionHardware", &settings->internal.toniebox_firmware.uaVersionHardware, "", "Hardware version from User Agent")
