...
static void option_map_init(uint8_t settingsId)
{
    ...
    OPTION_UNSIGNED("toniebox.field2", &settings->toniebox.field2, 0, 0, UINT32_MAX, "Field 2", "Unknown Toniebox setting, default 0", LEVEL_EXPERT)
    OPTION_UNSIGNED("toniebox.field6", &settings->toniebox.field6, 0, 0, UINT32_MAX, "Field 6", "Unknown Toniebox setting, default 0", LEVEL_EXPERT)
