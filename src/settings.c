...
OPTION_STRING("core.contentdir", &Settings.core.contentdir, "data/content", "Directory where cloud content is placed")
OPTION_STRING("core.wwwdir", &Settings.core.wwwdir, "data/www", "Directory where web content is placed")
