...
static void option_map_init(uint8_t settingsId)
{
    ...
    OPTION_UNSIGNED("toniebox.field2", &settings->toniebox.field2, 0, 7, UINT32_MAX, "Field 2", "Unknown Toniebox setting, default 7", LEVEL_EXPERT)
    OPTION_UNSIGNED("toniebox.field6", &settings->toniebox.field6, 0, 1, UINT32_MAX, "Field 6", "Unknown Toniebox setting, default 1", LEVEL_EXPERT)
