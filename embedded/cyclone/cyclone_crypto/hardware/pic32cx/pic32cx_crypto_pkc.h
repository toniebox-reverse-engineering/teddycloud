/**
 * @file pic32cx_crypto_pkc.h
 * @brief PIC32CX public-key hardware accelerator (PUKCC)
 *
 * @section License
 *
...
#ifndef _PIC32CX_CRYPTO_PKC_H
#define _PIC32CX_CRYPTO_PKC_H

//Dependencies
#include "core/crypto.h"

//Public-key hardware accelerator
#ifndef PIC32CX_CRYPTO_PKC_SUPPORT
   #define PIC32CX_CRYPTO_PKC_SUPPORT DISABLED
#elif (PIC32CX_CRYPTO_PKC_SUPPORT != ENABLED && PIC32CX_CRYPTO_PKC_SUPPORT != DISABLED)
   #error PIC32CX_CRYPTO_PKC_SUPPORT parameter is not valid
#endif
